...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 409, description: 'Email ou nom d\'utilisateur déjà utilisé' }),
...
__decorate([
    ...
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Renouveler le token JWT' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Token renouvelé' }),
    __param(0, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
